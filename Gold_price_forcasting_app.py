...
if page == 'Forecast':
    ...
    if forecast:
        ...
        def download_link(dataframe, file_name, link_text):
        ...
        # Add a download link for the forecast DataFrame
        st.markdown(download_link(forecast_df, 'forecast.csv', 'Download Forecast CSV'), unsafe_allow_html=True)
   ...
   # Add a download link for the custom forecast DataFrame
    st.markdown(download_link(custom_forecast, 'custom_forecast.csv', 'Download Custom Forecast CSV'), unsafe_allow_html=True)
